...
export function MyRecipeHome({dish, handleUpdate}:RecipeData) {
    ...
    return (
        <div className='fixed inset-0 z-[100] flex items-center justify-center py-4 bg-inherit animate-in fade-in duration-300'>
                    ...
                    {isEditing ? (
                        ...
                        <div className="bg-white py-6 px-2 bg-yellow-300 rounded-2xl shadow-sm space-y-4 border border-orange-200">
                            ...
                            <textarea
                                ...
                                defaultValue={dish.text}
                                onChange={(e) => setText(e.target.value)}
                                placeholder="Zapisz tresc przepisu..."
                            />
                            <div className="flex gap-3">
                                ...
                                >
                                    {isSaving ? "Zachowuje..." : <><Save size={18} /> Zapisz</>}
                                </button>
                            </div>
                        </div>
                    ) : (
